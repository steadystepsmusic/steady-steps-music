      ...
      <main className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-slate-300 text-lg leading-relaxed mb-3">
            An email with a few quick questions is on its way so we can get your free 15-minute lesson scheduled. Reply to that email and I&apos;ll propose a time.
          </p>
          <p className="text-slate-500 text-sm mb-12">Don&apos;t see it in a few minutes? Check your Promotions or Spam folder.</p>
