      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-4 gap-2 mb-8">
          <a
            ...
            className="flex flex-col items-center gap-1.5 bg-slate-800/50 border border-slate-700 rounded-xl py-3 hover:bg-slate-800 transition-colors"
          >
            <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-[#3D95CE]">
            ...
            <span className="text-white text-[11px] font-bold text-center leading-tight">Venmo</span>
          </a>
          ...
          <a
            ...
            className="flex flex-col items-center gap-1.5 bg-slate-800/50 border border-slate-700 rounded-xl py-3 hover:bg-slate-800 transition-colors"
          >
            <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{background: 'radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)'}}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-white text-[11px] font-bold text-center leading-tight">Instagram</span>
          </a>
          ...
          >
            <div className="w-9 h-9 rounded-lg overflow-hidden">
              <Image src="/images/nik-mathews-hero.jpeg" alt="Book Nik" width={36} height={36} style={{ objectFit: 'cover', objectPosition: '15% 10%' }} />
            </div>
            <span className="text-white text-[11px] font-bold text-center leading-tight">Book Nik</span>
          </a>
          ...
          >
            <div className="w-9 h-9 rounded-lg overflow-hidden">
              <Image src="/images/about.jpeg" alt="Book a lesson" width={36} height={36} style={{ objectFit: 'cover', objectPosition: '50% 25%' }} />
            </div>
            <span className="text-white text-[11px] font-bold text-center leading-tight">Lessons</span>
          </a>
        </div>
