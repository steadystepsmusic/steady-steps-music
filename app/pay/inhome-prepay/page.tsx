...
export const metadata: Metadata = {
  title: 'In-Home Monthly Prepay — Steady Steps Music',
  robots: { index: false, follow: false },
}

// ─── Stripe Payment Links ─────────────────────────────────────────────────────
// Create these in Stripe when a student requests in-home + monthly prepay, then
// paste the links here and redeploy.
const STRIPE = {
  monthly30: 'https://buy.stripe.com/4gMaEPaz66UQ3Vifb11RC06', // $240/mo — 30-min in-home, 4 lessons
  monthly45: 'https://buy.stripe.com/eVqcMXdLia720J63sj1RC07', // $312/mo — 45-min in-home, 4 lessons
  monthly60: 'https://buy.stripe.com/28EaEPdLieni3Vi6Ev1RC08', // $384/mo — 60-min in-home, 4 lessons
}

// ─── Plan data ────────────────────────────────────────────────────────────────
// 10% discount applies to the lesson fee only; the $15/session travel fee is full price.

const monthly = [
  { label: '30-Minute Lessons', price: '$240', note: '4 lessons / month', href: STRIPE.monthly30 },
  { label: '45-Minute Lessons', price: '$312', note: '4 lessons / month', href: STRIPE.monthly45 },
  { label: '60-Minute Lessons', price: '$384', note: '4 lessons / month', href: STRIPE.monthly60, highlight: true },
]

// ─── Page ─────────────────────────────────────────────────────────────────────

export default function PayInHomePrepayPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-14">
        <h2 className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-5">Monthly Prepay (4 Lessons)</h2>
